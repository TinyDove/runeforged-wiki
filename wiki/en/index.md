...
**Mod version: 0.2.3　Minecraft: 1.21.11, 26.1, 26.2, and 26.3**
...
!!! note "Server configuration"
    The wiki shows default configuration. Servers and modpacks can change `config/runeforged-*.json`; when values differ, the server's configuration and in-game results take precedence.
