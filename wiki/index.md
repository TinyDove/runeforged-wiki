...
| 系统 | 内容 | 页面 |
| --- | --- | --- |
| 装备 | 品质、词条 Tier、普通词条与特殊词条 | [品质与词条](equipment/quality-and-affixes.md) |
...
!!! note "服务器配置"
    Wiki 的数值采用模组当前代码生成的**默认配置**。服务器或整合包可以修改 `config/runeforged-*.json`；遇到不一致时，以服务器实际配置和运行结果为准。
